...
router.post("/updatevendorprofile", protectedRouteForVendor, vendorProfileController);
router.get("/getcurrentvendor", protectedRouteForVendor, getCurrentVendorProfile)
